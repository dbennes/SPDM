...
<script>
    ...
    reader.onload = function (e) {
        ...
        $.ajax({
            type: "POST",
            url: "php/funcoes/scripts/processar_arquivo cert.php",
            contentType: "application/json; charset=utf-8", // Adicionado para indicar que está enviando JSON
            dataType: "json", // Esperando uma resposta JSON do servidor
            data: JSON.stringify(finalArray), // Convertendo o array para JSON
            success: function (response) {
                ...
                if (response.message) {
                    // Exibir um pop-up ou alerta com a mensagem
                    alert(response.message); // Você também pode usar uma biblioteca de modais ou personalizar conforme necessário
                }
            ...
            error: function (xhr, status, error) {
                ...
                // Exibir o conteúdo da resposta do servidor
